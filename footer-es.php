...
<div id="footer-outer"
  ...
  <style>
    /* Corporate note: single line on laptop/desktop */
.corp-note-wrap{ display:flex; justify-content:flex-start; margin-bottom:10px; }
.corp-note{ margin:0; color:#000; text-align:left; }

/* Keep it on one line at ≥992px; allow normal wrapping below that */
@media (min-width: 992px){
  .corp-note{ white-space: nowrap; }
}
    ...
    <div class="container copyright-flex">
      ...
      <div class="col-md-6 span_7 col_last col-right">
        <ul id="menu-footer-menu" class="menu" style="display:flex; gap:14px; flex-wrap:wrap; justify-content:flex-end; padding:0; margin:0; list-style:none;">
          <li class="menu-item" style="display:inline;"><a href="privacy-policy-es" style="color:#333; text-decoration:none;">POLÍTICA DE PRIVACIDAD</a></li>
          <li class="menu-item" style="display:inline;"><a href="cookies-policy-es" style="color:#333; text-decoration:none;">POLÍTICA DE COOKIES</a></li>
          <li class="menu-item" style="display:inline;"><a href="legal-notice-es" style="color:#333; text-decoration:none;">AVISO LEGAL</a></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="corp-note-wrap" style="padding-left:35px;">
    <p class="corp-note" style="font-size:14px;color:#BDBDBD;">All rights reserved by S. Agro Sociedad Anónima - Tax Identification Number: A59154914</p>
  </div>
