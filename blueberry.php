...
<div class="cta-varieties products-grid"> <a class="nectar-button small regular accent-color regular-button pl-green-button" style="visibility: visible;" href="varieties" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff"><span>Find your variety</span></a></div><div class="woocommerce-notices-wrapper"></div>
<ul
  class="products-grid"
  data-n-lazy="1"
  data-rm-m-hover="off"
